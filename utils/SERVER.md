...
git config --global user.email 'julio.jcmarques@gmail.com'
...
```
git remote add agendarepo jcmarques@107.178.216.17:~/agendarepo
...
postgres=# create role myassist with login superuser createdb createrole password 'myassist';
CREATE ROLE
postgres=# create database data_base with owner myassist;
CREATE DATABASE
postgres=# grant all privileges on database data_base to myassist;
GRANT
postgres=# \q
